  ...
  return (
    <footer className="bg-slate-900 text-slate-300 pt-14 pb-12 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-r from-red-600 via-rose-600 to-red-700 rounded-3xl p-6 sm:p-8 mb-12 text-white shadow-xl shadow-red-950/30 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3 shrink-0">
            <button
              ...
              className="px-6 py-3 rounded-xl bg-white text-red-700 font-extrabold text-sm hover:bg-rose-50 shadow-md transition-all hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
            >
              Post Emergency Request (+91)
            </button>
            <button
              onClick={() => setActiveTab('find-donor')}
              className="px-5 py-3 rounded-xl bg-slate-950/80 hover:bg-slate-950 text-white font-bold text-sm border border-white/20 transition-all cursor-pointer"
            >
            ...
            <ul className="space-y-2 text-xs text-slate-400">
              <li>
                <button onClick={() => openAuthModal('login')} className="hover:text-white transition-colors flex items-center gap-1.5 cursor-pointer text-emerald-400 font-semibold">
                  ...
                  <span>Sign In (Email / Mobile)</span>
                </button>
              </li>
              <li>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          ...
          <div className="flex items-center gap-6">
            ...
            <span className="hover:text-slate-400">NBTC Guidelines</span>
            <span className="hover:text-slate-400">Medical Advisory</span>
          </div>
        </div>
      </div>
    </footer>
